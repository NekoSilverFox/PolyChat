...
| 102  | pt_ChatBox_userjoin          | тестирование производительности                              | ChatBox               | Доступ пользователей в групповой чат                         |
...
| 104  | pt_ChatBox_msgTextEdit_input | тестирование производительности                              | ChatBox               | Имитирует ввод пользователем с клавиатуры 100 символов в msgTextEdit и последующее нажатие кнопки отправить |
| 105  | pt_Login_to_system           | тестирование производительности                              | Login/ChatList        | Пользователи вводят свое имя и номер класса с клавиатуры, а затем нажимают кнопку входа для доступа к системе (ChatList). |
...
| 107  | lt_ChatBox_x100              | Нагрузочное тестирование                                     | ChatBox               | Пользователь **Доступ** 100 групповых чатов                  |
| 108  | lt_ChatBox_200user           | Нагрузочное тестирование                                     | ChatBox               | Гарантированные 200 пользователей на один чат                |
...
| 112  | lt_TcpCerver_x10             | Нагрузочное тестирование                                     | TcpClient             | Пользователь вызывает 10 окон отправки файлов TcpClient (получает 10 файлов) |
| 113  | ct_ChatBox_code_normal       | Тестирование на совместимость                                | ChatBox               | Имитирует ввод пользователем английского, китайского и русского языков в msgTextEdit с клавиатуры. При этом ui отображается корректно, без ошибок в коде. |
...
| 116  | GitHub CI                    | Тестирование на совместимость                                | ALL                   | Компилируйте в Qt6.2.2 и убедитесь, что минимальная версия для macOS - 10.12; минимальная версия для Windows 2019 |
